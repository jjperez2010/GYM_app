package com.example.appdeprueba.viewmodel
...
import com.example.appdeprueba.database.GymDatabase
...
import com.example.appdeprueba.repository.GymRepository
...
class GymViewModel(context: Context) : ViewModel() {
    ...
    fun setWaitingForUser(waiting: Boolean) { _isWaitingForUser.value = waiting }
