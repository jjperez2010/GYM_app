package com.example.appdeprueba.database
...
@Database(entities = [ExerciseEntity::class, RoutineEntity::class, WorkoutHistoryEntity::class, WeightEntity::class], version = 3)
